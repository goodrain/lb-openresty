...
dynamic_http_upstreams_dir = nginx_home .. "/conf/balances/dynamic_http_upstreams"
dynamic_stream_upstreams_dir = nginx_home .. "/conf/balances/dynamic_stream_upstreams"
